      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-zinc-600 text-sm">
              Handpicked sarees for every occasion. Quality, elegance, and tradition in every piece.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/sarees"
                  className="text-zinc-600 hover:text-amber-700 transition-colors text-sm"
                >
                  Browse Sarees
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-zinc-600 text-sm">
                ...
                <span>info@sareeboutique.com</span>
              </li>
              <li className="flex items-start text-zinc-600 text-sm">
                <MapPin className="h-4 w-4 mr-2 mt-1" />
                <span>123 Main Street, City, State 560001</span>
              </li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-zinc-900 mb-4">Follow Us</h4>
        ...
        <div className="mt-8 pt-8 border-t border-zinc-200">
          <p className="text-center text-zinc-600 text-sm">
            © {new Date().getFullYear()} Saree Boutique. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
